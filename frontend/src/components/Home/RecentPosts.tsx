  ...
  return (
    <div className="space-y-8">
      ...
      {pagination.totalPages > 1 && (
        <div className="flex items-center justify-center flex-wrap p-6 bg-white dark:bg-gray-900 rounded-2xl shadow-lg border border-gray-100 dark:border-gray-700">
          {/* Previous button */}
          <Button
            variant="outline"
            size="sm"
